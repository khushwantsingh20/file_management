...
#     if file_extension in file_extensions["documents"]:
#         move_file(file_path, files_path)
#     elif file_extension in file_extensions["images"]:
#         move_file(file_path, os.path.join(media_path, "Images"))
#     elif file_extension in file_extensions["videos"]:
#         move_file(file_path, os.path.join(media_path, "Videos"))
#     elif file_extension in file_extensions["audio"]:
#         move_file(file_path, os.path.join(media_path, "Audio"))
#     else:
#         # Move other files to the "Files" folder
#         move_file(file_path, files_path)
import os
import shutil
